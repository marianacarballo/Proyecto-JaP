...
//Desafiate
//Si bien el comentario ingresado no será enviado a ningún servidor, cuando se simule el envío del mismo, intenta agregarlo cómo un 
...
document.addEventListener("DOMContentLoaded", function(e) { //EVENTO Q SE ACTIVA CUANDO ABRIMOS EL HTML 
    ...
    document.getElementById("boton").addEventListener("click", function(e) {
        ...
        puntos = document.getElementById("clasificacion").value;
